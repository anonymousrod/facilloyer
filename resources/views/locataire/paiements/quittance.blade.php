    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="payment-info">
                ...
                <div class="payment-row">
                    <strong>Loyer du mois :</strong>
                    <span class="montant">{{ number_format($paiement->montant_total_periode, 2, ',', ' ') }} €</span>
                </div>
                <div class="payment-row">
                ...
                <div class="payment-row">
                    ...
                    <span class="montant-restant">{{ number_format($paiement->montant_restant, 2, ',', ' ') }} €</span>
                </div>
            </div>
        </div>
