                            ...
                            <div class="col-lg-3">
                                <div class="card border-primary">
                                    <div class="card-header bg-primary text-white">
                                        <h5 class="card-title mb-0"><i class="fas fa-calendar-plus"></i> Nouvel Événement
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <form id="eventForm">
                                            <div class="mb-3">
                                                <label for="eventTitle" class="form-label fw-bold">Titre de
                                                    l'événement</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="eventDescription" rows="4" placeholder="Détails de l'événement..." required></textarea>
                                            </div>
